...
#define FAIL_UNLESS_EQ(x, y)	do { auto xval = (x); auto yval = (y); if ((xval) != (yval)) { std::cout << __FILE__ << ":" << __LINE__ << ": " << #x << " (" << ((uintptr_t)xval) << ") != " << #y << " (" << ((uintptr_t)yval) << ")" << std::endl; exit(1); } } while(0)
#define FAIL_UNLESS_NE(x, y)	do { auto xval = (x); auto yval = (y); if ((xval) == (yval)) { std::cout << __FILE__ << ":" << __LINE__ << ": " << #x << " (" << ((uintptr_t)xval) << ") == " << #y << " (" << ((uintptr_t)yval) << ")" << std::endl; exit(1); } } while(0)
...
static void print_mapresult(const char *mr) {
	if (mr) {
		std::cout << "error: " << mr << std::endl;
		free_string(mr);
	}
}
		...
		.tests = {
			{
				...
				.runtest = [](){
					...
					char * mr = MM_Map(0, 0, 0);
					print_mapresult(mr);
					FAIL_UNLESS_EQ(mr, nullptr);
					return true;
				},
			},
			{
			...
			},
			{
				...
				.runtest = [](){
					// map the first page read only
					char * mr1 = MM_Map(0, addrN(0), 0);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(1), 0);
					print_mapresult(mr2);
					char * mr3 = MM_Map(0, addrN(2), 0);
					print_mapresult(mr3);
					FAIL_UNLESS_EQ(mr1, nullptr);
					FAIL_UNLESS_EQ(mr2, nullptr);
					FAIL_UNLESS_EQ(mr3, nullptr);
					return true;
				},
			},
			{
				...
				.runtest = [](){
					// map the first page read only
					char * mr1 = MM_Map(0, addrN(3), 1);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(5), 1);
					print_mapresult(mr2);
					char * mr3 = MM_Map(0, addrN(7), 1);
					print_mapresult(mr3);
					FAIL_UNLESS_EQ(mr1, nullptr);
					FAIL_UNLESS_EQ(mr2, nullptr);
					FAIL_UNLESS_EQ(mr3, nullptr);
			...
			},
			{
				...
				.runtest = [](){
					...
					char * mr1 = MM_Map(0, addrN(0), 0);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(1), 1);
					print_mapresult(mr2);
					char * mr3 = MM_Map(0, addrN(2), 0);
					print_mapresult(mr3);
					char * mr4 = MM_Map(0, addrN(3), 1);
					print_mapresult(mr4);
					FAIL_UNLESS_EQ(mr1, nullptr);
					FAIL_UNLESS_EQ(mr2, nullptr);
					FAIL_UNLESS_EQ(mr3, nullptr);
					FAIL_UNLESS_NE(mr4, nullptr);
					return true;
				},
			},
			{
			...
			},
			{
				...
				.runtest = [](){
					char * mr1 = MM_Map(0, addrN(2,0), 1);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(5,0), 1);
					print_mapresult(mr2);
					char * mr3 = MM_Map(0, addrN(3,0), 1);
					print_mapresult(mr3);
			...
			},
			{
				...
				.points = 2,
				.runtest = [](){
					char * mr1 = MM_Map(0, addrN(3,0), 1);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(4,0), 1);
					print_mapresult(mr2);
					std::vector<uint8_t> writes;
		...
		.tests = {
			{
				...
				.runtest = [](){
					MM_SwapOn();
					char * mr1 = MM_Map(0, addrN(1,0), 1);
					print_mapresult(mr1);
					char * mr2 = MM_Map(0, addrN(2,0), 1);
					print_mapresult(mr2);
					char * mr3 = MM_Map(0, addrN(3,0), 1);
					print_mapresult(mr3);
					char * mr4 = MM_Map(0, addrN(4,0), 1);
					print_mapresult(mr4);
			...
			},
			{
				...
				.runtest = [](){
					...
					char * mr4 = MM_Map(0, addrN(4,0), 1);
					print_mapresult(mr4);
					char * mr5 = MM_Map(0, addrN(5,0), 1);
					print_mapresult(mr5);
					char * mr6 = MM_Map(0, addrN(6,0), 1);
					print_mapresult(mr6);
		...
		.tests = {
			{
				...
				.points = 10,
				.runtest = [](){
					char * mr1 = MM_Map(0, addrN(5,0), 1);
					print_mapresult(mr1);
					char * mr2 = MM_Map(1, addrN(5,0), 1);
					print_mapresult(mr2);
